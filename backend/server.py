...
async def download_ea():
    ...
    return Response(
        ...
        headers={"Content-Disposition": 'attachment; filename="XAUUSD_AI_Sniper_EA_v5.8.54_PATIENT_PROFIT_SHIELD.mq5"'},
    )
...
async def admin_download_ea_master():
    ...
    return FileResponse(
        path=str(p),
        filename="XAUUSD_AI_Sniper_EA_MASTER_v5.8.54_PATIENT_PROFIT_SHIELD.mq5",
        media_type="application/octet-stream",
    )
