...
async def send_pin_email(to_email: str, buyer_name: str, pin: str):
    ...
    try:
        ...
        msg["Subject"] = "Your AI Sniper EA License PIN"
        msg["From"] = smtp_email
        msg["To"] = to_email
        html = f"""<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:20px;">
<h2 style="color:#B8860B;">AI Sniper EA - License PIN</h2>
...
async def get_how_it_works():
    return {"sections":[{"title":"How the AI Sniper EA Works","subtitle":"Complete guide to your trading bot","steps":[{"id":1,"title":"Market Scanning","description":"Scans XAUUSD across M5, H1, H4 every 5 minutes.","detail":"Multi-timeframe filters false signals."},{"id":2,"title":"AI Classification","description":"Classifies as TRENDING, RANGING, or BREAKOUT.","detail":"Weighted scoring system."},{"id":3,"title":"Strategy Selection","description":"Auto-selects Trend, Range, or Breakout mode.","detail":"Seamless switching."},{"id":4,"title":"Confidence Scoring","description":"Scores 0-100. Only executes above threshold.","detail":"Sniper approach = fewer, better trades."},{"id":5,"title":"Smart Entry & Exit","description":"ATR-based SL, 1.5:1 min R:R, partial close, trailing.","detail":"Locks profit early, lets winners run."},{"id":6,"title":"Risk Protection","description":"Per-trade, daily, weekly limits + cooldown.","detail":"3 losses = 30min pause. 3% daily = stop."},{"id":7,"title":"Pattern Learning","description":"Tracks every trade to build pattern memory.","detail":"AI gets smarter over time."},{"id":8,"title":"Profit Targeting","description":"20-50% weekly target. Stops when reached.","detail":"Conservative/Moderate/Aggressive modes."}]}],"faq":[{"q":"Keep computer on?","a":"Yes or use VPS ($5-10/mo) for 24/7."},{"q":"Account size?","a":"Min $500, recommended $1,000+."},{"q":"Multiple accounts?","a":"Each PIN = one account."},{"q":"All brokers?","a":"Any MT5 with XAUUSD. ECN best."},{"q":"Lose internet?","a":"SL/TP protect you. Resumes when back."},{"q":"Manual close?","a":"Yes, anytime."}]}
