...
const LoginRequestSchema = z.object({ email: z.string(), password: z.string() });
const AdminMfaLoginSchema = z.object({ mfa_token: z.string(), code: z.string() });
const AdminMfaEnableSchema = z.object({ code: z.string() });
const AdminMfaDisableSchema = z.object({ password: z.string(), code: z.string() });
