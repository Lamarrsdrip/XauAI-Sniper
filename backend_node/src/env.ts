...
export const env = {
  ...
  XAUCLOUD_LEASE_VALIDITY_SECONDS: Number(process.env["XAUCLOUD_LEASE_VALIDITY_SECONDS"] ?? "900"),
  XAUCLOUD_LEASE_RENEWAL_SECONDS: Number(process.env["XAUCLOUD_LEASE_RENEWAL_SECONDS"] ?? "300"),
