...
import { PositionDetailsScreen } from '../screens/home/PositionDetailsScreen';
...
import { CourseScreen } from '../screens/academy/CourseScreen';
...
import { BotControlScreen } from '../screens/more/BotControlScreen';
import { AIBrainScreen } from '../screens/more/AIBrainScreen';
import { PatternScannerScreen } from '../screens/more/PatternScannerScreen';
...
export const HomeNavigator: React.FC = () => (
  <HomeStack.Navigator screenOptions={noHeader}>
    ...
    <HomeStack.Screen name="PositionDetails" component={PositionDetailsScreen} />
  </HomeStack.Navigator>
);
...
export const AcademyNavigator: React.FC = () => (
  <AcademyStack.Navigator screenOptions={noHeader}>
    ...
    <AcademyStack.Screen name="Course" component={CourseScreen} />
    <AcademyStack.Screen name="Lesson" component={LessonScreen} />
    <AcademyStack.Screen name="Quiz" component={QuizScreen} />
...
export const MoreNavigator: React.FC = () => (
  <MoreStack.Navigator screenOptions={noHeader}>
    ...
    <MoreStack.Screen name="BotControl" component={BotControlScreen} />
    <MoreStack.Screen name="AIBrain" component={AIBrainScreen} />
    <MoreStack.Screen name="PatternScanner" component={PatternScannerScreen} />
