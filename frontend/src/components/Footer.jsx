      ...
      <div className="mx-auto max-w-7xl px-6 md:px-8 py-8">
        ...
        <div className="mt-6 border-t border-white/[0.05] pt-5 flex items-center justify-center">
          <a
            ...
            className="group flex items-center gap-2.5 rounded-full border border-amber-300/20 bg-amber-300/[0.06] px-4 py-2 transition hover:border-amber-300/40 hover:bg-amber-300/[0.12]"
          >
            <svg viewBox="0 0 24 24" className="h-3.5 w-3.5 text-amber-300 fill-current flex-none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="font-mono text-[11px] font-bold tracking-[0.2em] text-amber-200 group-hover:text-amber-100 transition">made by emriz.eth</span>
          </a>
        </div>
      </div>
    </footer>
