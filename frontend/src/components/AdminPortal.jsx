      ...
      <header className="sticky top-0 z-50 border-b border-white/[0.07] bg-[#060609]/92 backdrop-blur-2xl">
        <div className="mx-auto flex h-[56px] max-w-7xl items-center justify-between gap-3 px-5 md:px-8">
          <div className="flex items-center gap-3">
            ...
            <span className="rounded-full border border-white/[0.08] bg-white/[0.05] px-2 py-0.5 font-mono text-[9px] text-white/40">ADMIN · v6.21.0</span>
          </div>
    ...
    <div className={`min-h-screen ${BG} flex items-center justify-center p-6`} data-testid="admin-login-page">
      <div className="w-full max-w-sm">
        <div className="text-center mb-7">
          ...
          <p className="mt-1 text-[13px] text-white/38">v6.21.0 management portal</p>
        </div>
        ...
        <CardSection title="Latest bot heartbeat">
          <div className="grid grid-cols-2 gap-3 text-[12px]">
            {[
              ...
              ["EA version",     bot.ea_version || "v6.21.0"],
        ...
        <div className="space-y-5">
          <div className="flex items-center gap-3 pb-4 border-b border-white/[0.06]">
            ...
            <div>
              ...
              <div className="mt-0.5 font-mono text-[10px] text-amber-200">ADMIN · v6.21.0</div>
            </div>
          </div>
