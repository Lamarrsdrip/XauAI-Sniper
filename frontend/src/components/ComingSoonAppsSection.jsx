  ...
  return (
    <div aria-disabled="true"
      ...
      <span className="min-w-0 text-left leading-tight">
        <span className="block font-mono text-[8px] uppercase tracking-[0.14em] text-white/70">{top}</span>
        <span className="block text-[14px] font-bold text-white">{bottom}</span>
      </span>
      <span className="ml-auto rounded-full bg-[#F3C969]/20 px-2 py-1 font-mono text-[8px] font-bold uppercase tracking-wider text-[#F3C969]">Soon</span>
    </div>
  );
}
          ...
          <div className="grid gap-0 lg:grid-cols-[1.05fr_.95fr]">
            <div className="p-6 md:p-9">
              ...
              <div className="mt-5 grid max-w-lg gap-2 sm:grid-cols-2">
                {[
                  ...
                  <div key={text} className="flex items-center gap-2 rounded-xl bg-white/[0.05] px-3 py-2.5">
                    ...
                    <div>
                      <div className="font-mono text-[7.5px] uppercase tracking-[0.13em] text-white/70">{tag}</div>
                      <div className="mt-0.5 text-[10.5px] font-semibold text-white/90">{text}</div>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                ...
                <div className="inline-flex items-center gap-2 rounded-full border border-white/[0.12] bg-white/[0.04] px-4 py-3 text-[10.5px] font-semibold text-white/80">
            ...
            <div className="border-t border-white/[0.06] bg-black/20 p-6 md:p-9 lg:border-l lg:border-t-0">
              <div className="mx-auto max-w-sm">
                <div className="relative mx-auto w-[245px] rounded-[36px] border border-white/[0.14] bg-[#050507] p-3 shadow-[0_30px_70px_rgba(0,0,0,.45)]">
                  <div className="rounded-[28px] bg-[#0C0D12] p-4">
                    <div className="flex items-center justify-between">
                      <span className="flex h-8 w-8 items-center justify-center rounded-xl bg-[#F3C969]/20"><MonitorSmartphone className="h-4 w-4 text-[#F3C969]" /></span>
                      <span className="h-2 w-2 rounded-full bg-[#2FD3A0]" />
                    </div>
                    <div className="mt-5 font-mono text-[8px] uppercase tracking-[0.17em] text-white/70">XauCloud</div>
                    ...
                    <div className="mt-4 space-y-2">
                      {["Trading Bot", "AI Brain", "Analytics", "Support Center", "Forex Academy"].map((x, i) => (
                        <div key={x} className="flex items-center gap-2 rounded-xl bg-white/[0.05] px-3 py-2.5">
                          ...
                          <span className="text-[10.5px] font-semibold text-white/90">{x}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                ...
                <p className="mt-3 text-center font-mono text-[8px] uppercase tracking-[0.13em] text-white/60">
