...
function EaDownloadCard({ hasLicense, release }) {
  ...
  const filename = info?.filename || "XauCloud.io.ex5";
    ...
    <Card title="Download EA">
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          <p className="mt-1 text-[12px] leading-5 text-white/45">License-gated XauCloud.io.ex5 production build. The server verifies its SHA-256 checksum before every download.</p>
        </div>
        {!loading && (
