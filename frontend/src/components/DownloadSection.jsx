        ...
        <div className="mb-8 flex flex-col justify-between gap-5 md:flex-row md:items-end">
          <div>
            ...
            <p className="mt-3 max-w-2xl rounded-xl border border-white/[0.07] bg-white/[0.02] px-4 py-3 text-[12px] leading-5 text-white/45">
              <span className="font-semibold text-amber-200">Gold + Index, one EA.</span> Attach it to your XAUUSD chart and it trades gold exactly as it always has. Attach it to an index chart and it will auto-detect the market and run in monitoring-only Index Mode — full diagnostics, no live strategy yet. There is nothing to configure: <span className="font-mono text-white/60">InpMarketMode</span> defaults to <span className="font-mono text-white/60">AUTO_DETECT</span>.
            </p>
          </div>
