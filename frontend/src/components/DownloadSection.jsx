    ...
    <div className="bg-[#F8F9FA] border-t border-gray-100" data-testid="download-section">
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-24">
        <div className="mb-12">
          ...
          <p className="text-gray-500 mt-2">Download v4.7.1 — AI Exit Brain: full coverage. Claude now also vetoes PEAK_RETRACE & TIME_EXPIRED.</p>
        </div>
          ...
          <div className="bg-white border border-gray-200 rounded-3xl p-8 card-hover" data-testid="download-ea-card">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400 mt-1">v4.7.1 — Claude reasons before EVERY profit-side close. ~$1-2/mo. Zero rule-based exits left untested.</p>
              </div>
            </div>
            <div className="flex items-center gap-3 mb-5 text-[10px] font-mono text-gray-300 tracking-wide">
              <span>XAUUSD_AI_Sniper_EA.mq5</span><span>|</span><span>~155 KB</span><span>|</span><span>v4.7.1</span>
            </div>
