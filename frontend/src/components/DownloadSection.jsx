...
export default function DownloadSection({ api }) {
  ...
  const version  = info?.version  || "v6.21.3";
  const edition  = info?.edition  || "FULL-RISK BINARY MODE";
  const filename = info?.filename || "XAUUSD_AI_Sniper_EA_v6.21.3.mq5";
