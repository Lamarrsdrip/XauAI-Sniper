...
export default function DownloadSection({ api }) {
  ...
  const edition  = info?.edition  || "Gold-only Static Review Fixes";
        ...
        <div className="mb-8 flex flex-col justify-between gap-5 md:flex-row md:items-end">
          <div>
            ...
            <p className="mt-3 max-w-2xl rounded-xl border border-white/[0.07] bg-white/[0.02] px-4 py-3 text-[12px] leading-5 text-white/45">
              <span className="font-semibold text-amber-200">Gold-only v6.6.0.</span> This is the corrected XAUUSD AI Sniper build with the static-review exit fixes: phantom peak protection, hostile-only BOS/HTF flips, closed-bar TTM timing, and clean startup version logging.
            </p>
          </div>
