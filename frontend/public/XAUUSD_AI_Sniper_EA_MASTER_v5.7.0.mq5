...
//|                                     v5.7.0 — Stable Strategy Build|
//+------------------------------------------------------------------+
#property copyright "XauAI Sniper by emriz.eth"
#property link      "https://xauaisniper.com"
#property version   "5.70"
#property description "XAUUSD AI Sniper v5.7.0 — STABLE STRATEGY BUILD"
#property description "DISABLED: adaptive grade tightening (death-spiral mechanism)."
#property description "DISABLED: consecutive-loss tier escalation."
#property description "DISABLED: grade-filter in EPF tiers — only lot size adapts."
#property description "ADDED: hard daily DD stop (default -8%) — objective limit."
#property description "KEPT: v5.6.0 regime fixes (structural bug fix, not safer mode)."
#property strict
...
int OnInit()
{
   ...
   Print("=== XAUAI SNIPER v5.7.0 (STABLE STRATEGY BUILD) READY ===");
...
void UpdateDashboard(int signal, double score, string grade)
{
   ...
   string d = "\n";
   d += "==========================================\n";
   d += " XAUAI SNIPER v5.7.0 | MODE:" + g_modeName + " | ";
