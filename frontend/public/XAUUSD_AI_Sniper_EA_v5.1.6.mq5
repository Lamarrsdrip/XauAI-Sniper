...
//|                                     v5.1.6 — Trade aggressively   |
//+------------------------------------------------------------------+
#property copyright "XauAI Sniper by emriz.eth"
#property link      "https://xauaisniper.com"
#property version   "5.16"
#property description "XAUUSD AI Sniper v5.1.6 — Trade aggressively (default)"
#property description "  • DEFAULT InpAdaptiveGradeB = FALSE — base gradeB=2.5 always (was permanently"
#property description "    tightening to 3.0+ after losses, blocking score 2.0 setups indefinitely)."
#property description "  • Inherits v5.1.5 score floor (Combined ≥ setupScore × 0.65) + honest [SKIP] label"
#property description "  • Inherits v5.1.5 'TRADE BLOCKED BECAUSE: <reason>' explicit logs on every gate"
...
int OnInit()
{
   ...
   Print("=== XAUAI SNIPER v5.1.6 (AGGRESSIVE) READY ===");
...
void UpdateDashboard(int signal, double score, string grade)
{
   ...
   string d = "\n";
   d += "==========================================\n";
   d += " XAUAI SNIPER v5.1.6 | AGGRESSIVE | ";
