...
//|                                     v5.1.4 — Brake noise filter   |
//+------------------------------------------------------------------+
#property copyright "XauAI Sniper by emriz.eth"
#property link      "https://xauaisniper.com"
#property version   "5.14"
#property description "XAUUSD AI Sniper v5.1.4 — Giveback brake noise filter"
#property description "  • FIX: giveback brake no longer fires on a +0.5% day's normal price wiggle"
#property description "  • Brake only arms once HWM gain ≥ InpPG_GivebackMinGainPct (default 5%)"
#property description "  • Inherits v5.1.3 v4.9.7-style aggression: Profit Guardian OFF by default"
#property description "  • Always-on safety: per-position ratchet (BE @+1×ATR, trail @+2×ATR)"
#property strict
