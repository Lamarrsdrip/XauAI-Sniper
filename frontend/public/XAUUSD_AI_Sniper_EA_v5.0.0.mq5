...
#property description "XAUUSD AI Sniper v5.0.0 — Cloud Fanout (broadcasts master opens/closes to XauAi Cloud subscribers)"
#property description "NEW: POST /cloud/master/signal on open, /cloud/master/signal-close on close."
#property description "NEW: Periodic cloud heartbeat every 60s so admin panel shows master online."
#property description "Inherits v4.9.7 Smart Guards: basket protect, clean R-exits, fast-reversal circuit breaker."
#property strict
...
void UpdateDashboard(int signal, double score, string grade)
{
   ...
   string d = "\n";
   d += "==========================================\n";
   d += " XAUAI SNIPER v5.0.0 | CLOUD FANOUT | ";
