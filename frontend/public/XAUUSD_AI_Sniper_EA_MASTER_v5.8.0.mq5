...
//|                                     v5.8.0 — Data-Driven Rebuild |
//+------------------------------------------------------------------+
#property copyright "XauAI Sniper by emriz.eth"
#property link      "https://xauaisniper.com"
#property version   "5.80"
#property description "XAUUSD AI Sniper v5.8.0 — DATA-DRIVEN REBUILD"
#property description "Forensic analysis of 173 live trades (-$61k, PF 0.52):"
#property description "KILLED: TREND_PULLBACK setup (-$48k, PF 0.38)."
#property description "KILLED: BREAKOUT setup (-$8k, PF 0.34)."
#property description "KILLED: Adverse pyramiding (-$21k, PF 0.28)."
#property description "FIXED: Early-exit guard — won't close winner before +1R."
#property description "KEPT: SQUEEZE_RELEASE (+$13k, PF 4.36) + other +EV setups."
#property strict
...
// ====================================================================
input bool   InpAllowTrendPullback = false; // v5.8.0: DISABLED — lost $48k in live data
input bool   InpAllowBreakout       = false; // v5.8.0: DISABLED — lost $8k in live data
...
int OnInit()
{
   ...
   Print("=== XAUAI SNIPER v5.8.0 (DATA-DRIVEN REBUILD) READY ===");
...
void UpdateDashboard(int signal, double score, string grade)
{
   ...
   string d = "\n";
   d += "==========================================\n";
   d += " XAUAI SNIPER v5.8.0 | MODE:" + g_modeName + " | ";
