...
//|                                     v5.6.0 — Regime Leak Fix     |
//+------------------------------------------------------------------+
#property copyright "XauAI Sniper by emriz.eth"
#property link      "https://xauaisniper.com"
#property version   "5.60"
#property description "XAUUSD AI Sniper v5.6.0 — REGIME LEAK FIX"
#property description "FIX A: Regime-aware floor (CHOPPY/DEAD floor now 0)."
#property description "FIX B: With-trend bonus +1.5, counter-trend penalty -0.5."
#property description "FIX C: B-grade demoted to SKIP in CHOPPY/LOW_VOL/DEAD."
#property description "Aggressive mode unchanged (user observed it wins more)."
#property description "Includes v5.5.0 Equity Preservation Framework."
#property strict
...
int OnInit()
{
   ...
   Print("=== XAUAI SNIPER v5.6.0 (REGIME LEAK FIX) READY ===");
...
void UpdateDashboard(int signal, double score, string grade)
{
   ...
   string d = "\n";
   d += "==========================================\n";
   d += " XAUAI SNIPER v5.6.0 | MODE:" + g_modeName + " | ";
