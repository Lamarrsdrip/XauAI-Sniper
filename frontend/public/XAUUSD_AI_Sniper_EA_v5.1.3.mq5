...
//|                                     v5.1.3 — v4.9.7 + Profit Lock |
//+------------------------------------------------------------------+
#property copyright "XauAI Sniper by emriz.eth"
#property link      "https://xauaisniper.com"
#property version   "5.13"
#property description "XAUUSD AI Sniper v5.1.3 — v4.9.7 trading aggression + ONLY profit-lock safety nets"
#property description "  • DEFAULT: Profit Guardian module OFF (no tier risk-cuts, no HTF trend lock, no cooldown)"
#property description "  • ALWAYS-ON safety nets (independent of Profit Guardian master switch):"
#property description "    1. Escalating HWM giveback: +30% locks 80%, +50% locks 85%, +75% locks 90%"
#property description "    2. Per-position ratchet: SL→BE at +1×ATR profit, trail at +2×ATR profit"
#property description "  • Want full Profit Guardian back? Set InpProfitGuardian=true."
#property strict
