...
#property description "XAUUSD AI Sniper v5.1.1 — Adaptive HTF (M30 default, configurable, looser ATR threshold)"
#property description "FIX: HTF trend gate moved from H4 → M30 (gold turns too fast for H4 lock — late entries fixed)"
#property description "FIX: ATR threshold raised 1.5 → 2.0 so only TRULY strong trends block counter-signals"
#property description "Inherits v5.1.0 Profit Guardian (3-tier risk taper, HWM giveback brake, post-loss cooldown)."
#property strict
...
input ENUM_TIMEFRAMES InpPG_HTFTrendTF = PERIOD_M30;  // v5.1.1: HTF for trend lock — M30 default (was H4, too slow for gold)
input double InpPG_HTFTrendATR      = 2.0;   // v5.1.1: HTF price must be > EMA50 + this×ATR for "strong trend" (was 1.5)
