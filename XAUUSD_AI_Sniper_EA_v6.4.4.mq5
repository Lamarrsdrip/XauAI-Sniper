...
//|   v6.4.4 — Adaptive Recovery Mode: replaces hard daily loss       |
//|            lockout with intelligent high-selectivity continuation  |
//+------------------------------------------------------------------+
...
#property version   "6.4.4"
#property description "XAUUSD AI Sniper v6.4.4 — Adaptive Recovery Mode: replaces hard daily loss lockout with intelligent A/A+ continuation"
...
int OnInit()
{
   ...
   Print("=== XAUAI SNIPER v6.4.4 (AI DIRECTOR + ADAPTIVE WEIGHTS + AMPL + ADAPTIVE RECOVERY) READY ===");
...
void BotMonitorHeartbeat()
{
   ...
   ResetLastError();
   string body = StringFormat(
      "{\"pin\":\"%s\",\"license_key\":\"%s\",\"bot_online\":true,\"ea_version\":\"v6.4.4\",\"account_number\":\"%I64d\","
...
void UpdateDashboard(int signal, double score, string grade)
{
   ...
   string d = "\n";
   d += "==========================================\n";
   d += " XAUAI SNIPER v6.4.4 | MODE:" + g_modeName + " | ";
