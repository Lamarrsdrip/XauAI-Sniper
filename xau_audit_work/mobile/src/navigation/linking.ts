...
export const linking: LinkingOptions<any> = {
  ...
  config: {
    screens: {
      HomeTab: { screens: { Home: 'home', PositionDetails: 'home/position' } },
      TradingTab: {
        screens: {
          TradingHome: 'trading',
      ...
      LearnTab: {
        screens: {
          Academy: 'academy',
          Course: 'academy/course/:courseId',
          Lesson: 'academy/course/:courseId/lesson/:lessonId',
          Quiz: 'academy/course/:courseId/quiz/:quizId',
        },
      },
      MoreTab: {
        screens: {
          ...
          Support: 'support',
          TicketThread: 'support/ticket/:id/:subject?',
          Billing: 'billing',
          BotLicense: 'bot',
