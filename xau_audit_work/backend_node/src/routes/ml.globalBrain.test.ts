...
describe("global brain -- ml.ts wiring", () => {
  ...
  it("keeps unauthenticated SKIPPED shadow telemetry out of the trusted Global Brain corpus", async () => {
    ...
    expect(state.db.collection("ml_shadow_decisions").docs).toHaveLength(1);
