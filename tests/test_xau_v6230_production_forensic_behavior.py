"""Executable scenario models and source-wiring checks for production v6.23.3.
...
EA_PATH = ROOT / "XAUUSD_AI_Sniper_EA_v6.23.3.mq5"
...
def test_source_identity_and_mirror_are_exact():
    ...
    assert '#property version   "6.233"' in source
    assert '#define XAUAI_EA_VERSION "v6.23.3"' in source
    assert 'XAUAI_BUILD_HASH "v6233-continuation-health-reasoning-20260715"' in source
