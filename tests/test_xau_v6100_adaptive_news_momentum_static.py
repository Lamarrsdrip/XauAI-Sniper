...
def test_v6100_version_labels_and_download_source_are_current():
    ...
    assert 'v6.10.0 — ADAPTIVE NEWS MOMENTUM ENGINE' in ea
    assert '#property version   "6.100"' in ea
    assert '#define XAUAI_EA_VERSION "v6.10.0"' in ea
    assert '#define XAUAI_EA_VERSION_NUM "6.10.0"' in ea
    assert '#define XAUAI_BUILD_HASH "v6100-adaptive-news-momentum-engine-20260702"' in ea
