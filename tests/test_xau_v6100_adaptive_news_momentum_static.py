...
def test_v6100_version_labels_and_download_source_are_current():
    ...
    assert '#define XAUAI_EA_VERSION_NUM "6.14.0"' in ea
    assert '#define XAUAI_BUILD_HASH "v6140-24h-runner-quality-htf-location-20260706"' in ea
